 ...
 * =================================================================
 *
 *       Filename:  ss_dsi_flash_dimming_S6E3HAB_AMB623TS01.c
 *
 ...
 *
 */
#ifndef _SS_DSI_INTERPOLATION_S6E3HAB_AMB623TS01_H_
#define _SS_DSI_INTERPOLATION_S6E3HAB_AMB623TS01_H_
...
int init_interpolation_S6E3HAB_AMB623TS01(struct samsung_display_driver_data *vdd,
		struct brightness_table *br_tbl, enum INTERPOLATION_MODE mode);
int flash_gamma_support_S6E3HAB_AMB623TS01(struct samsung_display_driver_data *vdd);

/* Below formula could be changed for each panel */
void gen_hbm_interpolation_gamma_S6E3HAB_AMB623TS01(struct samsung_display_driver_data *vdd,
		struct brightness_table *br_tbl,
		struct ss_interpolation_brightness_table *normal_table, int normal_table_size);
void gen_hbm_interpolation_irc_S6E3HAB_AMB623TS01(struct samsung_display_driver_data *vdd,
		struct brightness_table *br_tbl,
		struct ss_interpolation_brightness_table *hbml_table, int hbm_table_size);
void gen_normal_interpolation_irc_S6E3HAB_AMB623TS01(struct samsung_display_driver_data *vdd,
		struct brightness_table *br_tbl,
		struct ss_interpolation_brightness_table *normal_table, int normal_table_size);
