 ...
 * 02110-1301 USA
 */
#ifndef _SX9360_I2C_SUB2_REG_H_
#define _SX9360_I2C_SUB2_REG_H_
...
/* Who Am I */
#ifdef CONFIG_SENSORS_SX9364_SUB2
#define WHO_AM_I 100
#else
...
#define SX9360_REGGNRLCTL2	"sx9360_sub2,reggnrlctrl2_reg"
#define SX9360_REFRESOLUTION	"sx9360_sub2,refresolution_reg"
#define SX9360_REFAGAINFREQ	"sx9360_sub2,refagainfreq_reg"
#define SX9360_RESOLUTION	"sx9360_sub2,resolution_reg"
#define SX9360_AGAINFREQ	"sx9360_sub2,againfreq_reg"
#define SX9360_REFGAINRAWFILT	"sx9360_sub2,refgainrawfilt_reg"
#define SX9360_GAINRAWFILT	"sx9360_sub2,gainrawfilt_reg"
#define SX9360_REGPROXCTRL3	"sx9360_sub2,regproxctrl3_reg"
#define SX9360_HYST		"sx9360_sub2,hyst_reg"
#define SX9360_PROXTHRESH	"sx9360_sub2,proxthresh_reg"
#define SX9360_HALLIC_CERT      "sx9360_sub2,hallic_cert_detect"
...
#define GRIP_ERR(fmt, ...) pr_err("[GRIP_SUB2] %s: "fmt, __func__, ##__VA_ARGS__)
#define GRIP_INFO(fmt, ...) pr_info("[GRIP_SUB2] %s: "fmt, __func__, ##__VA_ARGS__)
#define GRIP_WARN(fmt, ...) pr_warn("[GRIP_SUB2] %s: "fmt, __func__, ##__VA_ARGS__)

#endif /* _SX9360_I2C_SUB2_REG_H_*/
